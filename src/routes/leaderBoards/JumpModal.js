...
const JumpModal = ({
  ...
  const searchJump = (value) => {
    ...
    dispatch({type: 'leaderBoards/getJumpData', payload: {opts}});
  };
  return (
    <Modal {...jumpModalProps} title="选择内容">
      ...
      <Table rowKey='id' size='small' columns={tableColum} dataSource={leaderBoards.jumpData}
             loading={loading.effects['leaderBoards/getJumpData']}></Table>
    </Modal>
  )
};
JumpModal.propTypes = {
