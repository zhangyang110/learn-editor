...
(function(root, factory) {
  ...
  describe('Event', function() {
    it('should create an instance of Event', function() {
      ...
      //var instane = new Tvapi.Event();
      //expect(instance).to.be.a(Tvapi.Event);
    });
    ...
    it('should have the property extraParameter (base name: "extraParameter")', function() {
      // uncomment below and update the code to test the property extraParameter
      //var instane = new Tvapi.Event();
      //expect(instance).to.be();
    });
